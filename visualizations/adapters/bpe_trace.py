...
from bpe import BytePairEncoder, count_adjacent_pairs, merge_pair, utf8_tokens
...
def _validate_payload(payload: object) -> tuple[list[str], int, str]:
...
def build_bpe_trace(payload: object) -> dict[str, Any]:
    ...
    corpus, vocab_size, text = _validate_payload(payload)
