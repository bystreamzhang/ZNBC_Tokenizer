...
from .adapters.split_overview import (
...
def resolve_static_file(url_path: str) -> Path | None:
    ...
    relative_path = (
        "split.html" if decoded_path == "/" else decoded_path.lstrip("/")
    )
...
class VisualizationRequestHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self) -> None:  # noqa: N802 - BaseHTTPRequestHandler API
        ...
        api_builders = {
            "/api/split-bpe/overview": build_split_overview,
        }
